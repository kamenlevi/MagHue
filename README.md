...
Out of the box, macOS keeps the MagSafe LED orange until the battery hits 100%.
...
color (`0` system, `1` off, `3` green, `4` orange). Writing SMC keys requires
